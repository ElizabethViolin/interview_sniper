  ...
  return (
    <main className='h-full w-full bg-gradient-to-r from-blue-700 to-transparent to-blue-700'>
      <div className='w-full flex flex-col justify-center items-center py-10'>
        <div className='flex flex-col h-fit w-1/2 bg-[rgba(229,229,229,0.2)] rounded-xl p-7'>
        ...
        <div className='flex h-fit w-1/2 bg-[rgba(229,229,229,0.2)] p-1.5 rounded-xl mt-10'>        
